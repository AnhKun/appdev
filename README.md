...
1. Configuration Installations: this project uses Raspberry Pi, soundcard USB and microphone
	* Raspberry Pi:
First of all, you need to set up your Raspberry Pi to send ip address by email.
More information you can click here: https://portal.vamk.fi/mod/resource/view.php?id=388584
	* Soundcard USB:
...
2. Installation Instructions: you need to install the libcurl first then my source code
	* Install the libcurl:
...
Firstly, you should create a new folder to save this project.
Then, in your terminal, type the command: git clone https://github.com/AnhKun/appdev

3. Operating Instructions
	- Run "make" to execute the project 
	- If you want to record your voice, display it in barchart and count the number of peaks, run "./sound.out"
If you want to stop, press and hold Ctrl then press 
...
5. Copyleft: first thing, i am gratefull for receiving a lot of helps from DR.Gao Chao to complete 
